class ImageModelFull {
  ...
  UrlsFull? get urls => _urls;
  set urls(UrlsFull? urls) => _urls = urls;
  LinksFull? get links => _links;
  set links(LinksFull? links) => _links = links;
  ...
  SponsorshipFull? get sponsorship => _sponsorship;
  set sponsorship(SponsorshipFull? sponsorship) => _sponsorship = sponsorship;
  SponsorFull? get user => _user;
  set user(SponsorFull? user) => _user = user;
  ...
  ImageModelFull.fromJson(Map<String, dynamic> json) {
    ...
    _urls = json['urls'] != null ? UrlsFull.fromJson(json['urls']) : null;
    _links = json['links'] != null ? LinksFull.fromJson(json['links']) : null;
    _likedByUser = json['liked_by_user'];
    _sponsorship = json['sponsorship'] != null
        ? SponsorshipFull.fromJson(json['sponsorship'])
        : null;
    _user = json['user'] != null ? SponsorFull.fromJson(json['user']) : null;
  }
...
class SponsorshipFull {
  String _tagline = "";
  String _taglineUrl = "";
  SponsorFull? _sponsor;

  SponsorshipFull(
      {required String tagline, required String taglineUrl, SponsorFull? sponsor}) {
  ...
  SponsorFull? get sponsor => _sponsor;
  set sponsor(SponsorFull? sponsor) => _sponsor = sponsor;

  SponsorshipFull.fromJson(Map<String, dynamic> json) {
    _tagline = json['tagline'];
    _taglineUrl = json['tagline_url'];
    _sponsor = json['sponsor'] != null
...
class SponsorFull {
  ...
  String? _location;
  LinksFull? _links;
  ProfileImageFull? _profileImage;
  ...
  LinksFull? get links => _links;
  set links(LinksFull? links) => _links = links;
  ProfileImageFull? get profileImage => _profileImage;
  set profileImage(ProfileImageFull? profileImage) =>
